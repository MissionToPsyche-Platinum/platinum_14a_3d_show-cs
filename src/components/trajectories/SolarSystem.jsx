...
const PSYCHE  = { name: '16 Psyche',  trajectory: { aphelion: 497,    perihelion: 378,     timeOfPerihelion: 1745841600, inclination: 3.09,  longitudeAscendingNode: 150,    argumentOfPerihelion: 229.8,  orbitalPeriod: 1825.6, style: { color: 0xF5A020, opacity: 0.25 }, icon: { type: 'hexagon', color: 0xF5A020 } } }
const MERCURY = { name: 'Mercury', trajectory: { aphelion: 69.82,  perihelion: 46,      timeOfPerihelion: 1756296000, inclination: 3.38,  longitudeAscendingNode: 48.33,  argumentOfPerihelion: 29.12,  orbitalPeriod: 87.97,  style: { color: 0x9898AA, opacity: 0.25 }, icon: { type: 'circle',  color: 0x9898AA } } }
const VENUS   = { name: 'Venus',   trajectory: { aphelion: 108.94, perihelion: 107.48,  timeOfPerihelion: 1759406400, inclination: 3.86,  longitudeAscendingNode: 76.68,  argumentOfPerihelion: 54.88,  orbitalPeriod: 224.7,  style: { color: 0xE8C050, opacity: 0.25 }, icon: { type: 'circle',  color: 0xE8C050 } } }
const EARTH   = { name: 'Earth',   trajectory: { aphelion: 152.1,  perihelion: 147.1,   timeOfPerihelion: 1767441600, inclination: 7.155, longitudeAscendingNode: -11.26, argumentOfPerihelion: 114.21, orbitalPeriod: 365.25, style: { color: 0x48A8E0, opacity: 0.25 }, icon: { type: 'circle',  color: 0x48A8E0 } } }
const MARS    = { name: 'Mars',    trajectory: { aphelion: 249.2,  perihelion: 206.7,   timeOfPerihelion: 1655812800, inclination: 5.65,  longitudeAscendingNode: 49.56,  argumentOfPerihelion: 286.5,  orbitalPeriod: 687,    style: { color: 0xD85030, opacity: 0.25 }, icon: { type: 'circle',  color: 0xD85030 } } }
const JUPITER = { name: 'Jupiter', trajectory: { aphelion: 816.62, perihelion: 740.52,  timeOfPerihelion: 1674302400, inclination: 6.09,  longitudeAscendingNode: 100.46, argumentOfPerihelion: 273.87, orbitalPeriod: 4331,   style: { color: 0xC88050, opacity: 0.25 }, icon: { type: 'circle',  color: 0xC88050 } } }
const SATURN  = { name: 'Saturn',  trajectory: { aphelion: 1514.5, perihelion: 1352.55, timeOfPerihelion: 1985342400, inclination: 5.51,  longitudeAscendingNode: 113.67, argumentOfPerihelion: 339.39, orbitalPeriod: 10747,  style: { color: 0xDCBE72, opacity: 0.25 }, icon: { type: 'circle',  color: 0xDCBE72 } } }
const URANUS  = { name: 'Uranus',  trajectory: { aphelion: 3003.6, perihelion: 2741.3,  timeOfPerihelion: 2544436800, inclination: 6.48,  longitudeAscendingNode: 74.01,  argumentOfPerihelion: 97.00,  orbitalPeriod: 30589,  style: { color: 0x5EC8C4, opacity: 0.25 }, icon: { type: 'circle',  color: 0x5EC8C4 } } }
const NEPTUNE = { name: 'Neptune', trajectory: { aphelion: 4545.7, perihelion: 4457.1,  timeOfPerihelion: 2293444800, inclination: 6.43,  longitudeAscendingNode: 131.78, argumentOfPerihelion: 273.19, orbitalPeriod: 59800,  style: { color: 0x2858D0, opacity: 0.25 }, icon: { type: 'circle',  color: 0x2858D0 } } }
